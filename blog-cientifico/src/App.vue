<template>
  <div class="relative min-h-screen overflow-x-hidden font-sans">
    <!-- Background Layer -->
    <div class="fixed inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 -z-20"></div>
